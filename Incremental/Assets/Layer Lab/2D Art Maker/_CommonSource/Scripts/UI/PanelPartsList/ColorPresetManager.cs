...
namespace LayerLab.ArtMaker
{
    public class ColorPresetManager : MonoBehaviour
    {
        ...
        /// </summary>
        public void SetRandomAllColor(PartsManager partsManager)
        {
            if (ColorPicker.Instance != null)
            {
            ...
            {
                ApplyRandomColor(partsManager, PartsType.Hair_Short);
                ApplyRandomColor(partsManager, PartsType.Brow);
                ApplyRandomColor(partsManager, PartsType.Beard);
                ApplyRandomColor(partsManager, PartsType.Skin);
            }
        }
        ...
        /// </summary>
        /// <param name="partsType">부품 유형</param>
        private void ApplyRandomColor(PartsManager partsManager, PartsType partsType)
        {
        ...
        /// </summary>
        /// <param name="partsType">부품 유형</param>
        private void SetRandomColorFromPicker(PartsManager partsManager, PartsType partsType)
        {
            Color randomColor = ColorPicker.Instance.ApplyRandomPositionToPart(partsManager, partsType);
            _customColors[partsType] = randomColor;
